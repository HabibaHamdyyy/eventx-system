...
const AdminDashboard = () => {
  ...
  const revenueTarget = 500000; // EGP - can be made dynamic
  ...
  const generateSeatGrid = () => {
    ...
    const totalSeats = 100; // Display grid size (10x10)
    ...
    const reservedSeats = Math.floor(totalSeats * 0.15); // 15% reserved
